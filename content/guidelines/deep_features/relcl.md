---
title: "@relcl"
request: pattern { X -[deep=relcl]-> Y }
scope:
  schema: SUD
type: doc
tags:
...
5	've	have	AUX	_	_	3	mod@relcl	_	highlight=red
...
3	теории	теория	NOUN	NN	Animacy=Inan|Case=Nom|Gender=Fem|Number=Plur	1	subj	_	SpaceAfter=No|highlight=red
...
7	было	быть	AUX	VBC	Aspect=Imp|Gender=Neut|Mood=Ind|Number=Sing|Tense=Past|VerbForm=Fin|Voice=Act	3	mod@relcl	_	highlight=red
