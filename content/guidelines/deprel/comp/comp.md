...
In the case of **passive reflexive constructions**, the pronoun is labelled `comp` with the deep syntactic feature [`@pass`](guidelines/deep_features/pass.md).
...
We can also have the deep syntactic feature [`@expl`](guidelines/deep_features/expl.md) for the label `comp`. 
